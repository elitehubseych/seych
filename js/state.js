        ...
        const EMPTY_CHAT_PHRASES = [
            ...
            "Плохой день? Напишите что-нибудь, и он станет лучше!",
            "Пора оживить этот чат! Напишите что-нибудь!",
            "Снова грустно? Давайте вместе создадим что-то весёлое!",
            "Может Вас здесь ждут? Напишите что-нибудь и проверьте!",
            "Этот чат по Вам скучал! Напишите что-нибудь и оживите его!",
            "Вы прекрасны! А тут пусто. Давайте исправим это вместе!",
            "У Вас всё хорошо? Напишите что-нибудь и сделайте этот чат лучше!",
            "Игнорируют? Стоит выбрать: написать что-нибудь или уйти.",
            "Это место когда-то было наполнено смехом и радостью. Давайте вернём это!",
            "Нежеужели нужно выбирать между молчанием и общением? Напишите что-нибудь!",
            "Вам стало лучше? А тут пусто. Давайте исправим это вместе!",
            "Хотите общатся? Но думаете, что навязываетесь? Напишите что-нибудь и результат Вас удивит!",
            "Мне кажется, что у Вас получится хорошая история. Давайте начнём её вместе!",
            "Этот чат молчит, но Вы можете изменить это! Напишите что-нибудь!",
            ...
            'Не стоит откладывать на завтра, если ты можешь написать сейчас!',
            'Не получилось? Попробуйте снова, и вы удивитесь результату!',
            "Не сегодня так сейчас! Начните диалог и создайте что-то удивительное!",
